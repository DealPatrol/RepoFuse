    ...
    <div className="w-full max-w-3xl mx-auto">
      {!hasSubmitted ? (
        <div className="space-y-6">
          {/* Main Headline */}
          <h1 className="font-mono text-4xl sm:text-5xl md:text-6xl font-bold leading-[1.2] tracking-tight text-[#F0F6FC] mb-6">
            Your Million Dollar Idea<br className="hidden sm:block" />
        ...
        <div className="space-y-4 animate-in fade-in duration-300">
          ...
          <div className="flex justify-start">
            <div className="max-w-xs bg-[#161B22] border border-[#30363D] text-[#F0F6FC] rounded-lg px-4 py-3 space-y-3">
              <p className="text-sm">
                Perfect! I&apos;ll analyze your repositories for{' '}
                <span className="font-semibold text-[#06B6D4]">{userMessage}</span>{' '}
                opportunities and surface hidden ideas.
              </p>
              <p className="text-xs text-[#8B949E]">To continue, sign in with GitHub to get started.</p>
            </div>
          </div>
